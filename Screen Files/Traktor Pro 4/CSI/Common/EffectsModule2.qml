...
Module
{
  ...
  onActiveChanged: {
  	...
  	active && settings.autoEnableFX2 ? fxAssign.value = true : fxAssign.value = false;
  }
  property string deckPropertiesPath: ""
  property int fxUnit: 0
  
  property int effect1: settings.fx2pad1
  property int effect2: settings.fx2pad2
  property int effect3: settings.fx2pad3
  property int effect4: settings.fx2pad4
  property int effect5: settings.fx2pad5
  property int effect6: settings.fx2pad6
  property int effect7: settings.fx2pad7
  property int effect8: settings.fx2pad8
  ...
  WiresGroup
  {
    ...
    WiresGroup
    {
	  enabled: !module.shift  && !settings.toggleOnly2
 	  Wire {
		from: "%surface%.pads.1";
				...
				!module.button1val ? slot1.value = module.effect1 : 
					!module.button2val ? slot2.value = module.effect1 : 
						!module.button3val ? slot3.value = module.effect1 : 
							module.effect1 = module.effect1; 
				(settings.fx2pad1set == true) && slot1.value == module.effect1 ? knob1.value = settings.fx2pad1value/100 : module.effect1 = module.effect1 	
					(settings.fx2pad1set == true) && slot2.value == module.effect1 ? knob2.value = settings.fx2pad1value/100 : module.effect1 = module.effect1 	
						(settings.fx2pad1set == true) && slot3.value == module.effect1 ? knob3.value = settings.fx2pad1value/100 : module.effect1 = module.effect1 	
			}
			onRelease:
			{ 
				...
				!module.button1val ? slot1.value = module.effect2 : 
					!module.button2val ? slot2.value = module.effect2 : 
						!module.button3val ? slot3.value = module.effect2 : 
							module.effect2 = module.effect2; 
				(settings.fx2pad2set == true) && slot1.value == module.effect2 ? knob1.value = settings.fx2pad2value/100 : module.effect2 = module.effect2 	
					(settings.fx2pad2set == true) && slot2.value == module.effect2 ? knob2.value = settings.fx2pad2value/100 : module.effect2 = module.effect2 	
						(settings.fx2pad2set == true) && slot3.value == module.effect2 ? knob3.value = settings.fx2pad2value/100 : module.effect2 = module.effect2 	
				...
				!module.button1val ? slot1.value = module.effect3 : 
					!module.button2val ? slot2.value = module.effect3 : 
						!module.button3val ? slot3.value = module.effect3 : 
							module.effect3 = module.effect3; 
				(settings.fx2pad3set == true) && slot1.value == module.effect3 ? knob1.value = settings.fx2pad3value/100 : module.effect3 = module.effect3 	
					(settings.fx2pad3set == true) && slot2.value == module.effect3 ? knob2.value = settings.fx2pad3value/100 : module.effect3 = module.effect3 	
						(settings.fx2pad3set == true) && slot3.value == module.effect3 ? knob3.value = settings.fx2pad3value/100 : module.effect3 = module.effect3 								
			}
			onRelease:
			{ 
				...
				!module.button1val ? slot1.value = module.effect4 : 
					!module.button2val ? slot2.value = module.effect4 : 
						!module.button3val ? slot3.value = module.effect4 : 
							module.effect4 = module.effect4; 
				(settings.fx2pad4set == true) && slot1.value == module.effect4 ? knob1.value = settings.fx2pad4value/100 : module.effect4 = module.effect4 	
					(settings.fx2pad4set == true) && slot2.value == module.effect4 ? knob2.value = settings.fx2pad4value/100 : module.effect4 = module.effect4 	
						(settings.fx2pad4set == true) && slot3.value == module.effect4 ? knob3.value = settings.fx2pad4value/100 : module.effect4 = module.effect4 	
			}
			onRelease:
			{ 
				...
				!module.button1val ? slot1.value = module.effect5 : 
					!module.button2val ? slot2.value = module.effect5 : 
						!module.button3val ? slot3.value = module.effect5 : 
							module.effect5 = module.effect5; 
				(settings.fx2pad5set == true) && slot1.value == module.effect5 ? knob1.value = settings.fx2pad5value/100 : module.effect5 = module.effect5 	
					(settings.fx2pad5set == true) && slot2.value == module.effect5 ? knob2.value = settings.fx2pad5value/100 : module.effect5 = module.effect5 	
						(settings.fx2pad5set == true) && slot3.value == module.effect5 ? knob3.value = settings.fx2pad5value/100 : module.effect5 = module.effect5 	
			}
			onRelease:
			{ 
				...
				!module.button1val ? slot1.value = module.effect6 : 
					!module.button2val ? slot2.value = module.effect6 : 
						!module.button3val ? slot3.value = module.effect6 : 
							module.effect6 = module.effect6; 
				(settings.fx2pad6set == true) && slot1.value == module.effect6 ? knob1.value = settings.fx2pad6value/100 : module.effect6 = module.effect6 	
					(settings.fx2pad6set == true) && slot2.value == module.effect6 ? knob2.value = settings.fx2pad6value/100 : module.effect6 = module.effect6 	
						(settings.fx2pad6set == true) && slot3.value == module.effect6 ? knob3.value = settings.fx2pad6value/100 : module.effect6 = module.effect6 	
			}
			onRelease:
			{ 
				...
				!module.button1val ? slot1.value = module.effect7 : 
					!module.button2val ? slot2.value = module.effect7 : 
						!module.button3val ? slot3.value = module.effect7 : 
							module.effect7 = module.effect7; 
				(settings.fx2pad7set == true) && slot1.value == module.effect7 ? knob1.value = settings.fx2pad7value/100 : module.effect7 = module.effect7 	
					(settings.fx2pad7set == true) && slot2.value == module.effect7 ? knob2.value = settings.fx2pad7value/100 : module.effect7 = module.effect7 	
						(settings.fx2pad7set == true) && slot3.value == module.effect7 ? knob3.value = settings.fx2pad7value/100 : module.effect7 = module.effect7 	
			}
			onRelease:
			{ 
				...
				!module.button1val ? slot1.value = module.effect8 : 
					!module.button2val ? slot2.value = module.effect8 : 
						!module.button3val ? slot3.value = module.effect8 : 
							module.effect8 = module.effect8; 
				(settings.fx2pad8set == true) && slot1.value == module.effect8 ? knob1.value = settings.fx2pad8value/100 : module.effect8 = module.effect8 	
					(settings.fx2pad8set == true) && slot2.value == module.effect8 ? knob2.value = settings.fx2pad8value/100 : module.effect8 = module.effect8 	
						(settings.fx2pad8set == true) && slot3.value == module.effect8 ? knob3.value = settings.fx2pad8value/100 : module.effect8 = module.effect8 	
			}
			onRelease:
			{ 
			...
			(slot1.value == module.effect2) || (slot2.value == module.effect2) || (slot3.value == module.effect2) ? (slot1.value == module.effect2 ? slot1.value = 0 : slot2.value == module.effect2 ? slot2.value = 0 : slot3.value == module.effect2 ? slot3.value = 0 : module.effect1 = module.effect1) :	
				!module.button1val ? slot1.value = module.effect2 : 
					!module.button2val ? slot2.value = module.effect2 : 
						!module.button3val ? slot3.value = module.effect2 : 
							module.effect1 = module.effect1; 
				(settings.fx2pad2set == true) && slot1.value == module.effect1 ? knob1.value = settings.fx2pad2value/100 : module.effect1 = module.effect1 	
					(settings.fx2pad2set == true) && slot2.value == module.effect1 ? knob2.value = settings.fx2pad2value/100 : module.effect1 = module.effect1 	
						(settings.fx2pad2set == true) && slot3.value == module.effect1 ? knob3.value = settings.fx2pad2value/100 : module.effect1 = module.effect1 	
			}
			...
			(slot1.value == module.effect3) || (slot2.value == module.effect3) || (slot3.value == module.effect3) ? (slot1.value == module.effect3 ? slot1.value = 0 : slot2.value == module.effect3 ? slot2.value = 0 : slot3.value == module.effect3 ? slot3.value = 0 : module.effect3 = module.effect3) :	
				!module.button1val ? slot1.value = module.effect3 : 
					!module.button2val ? slot2.value = module.effect3 : 
						!module.button3val ? slot3.value = module.effect3 : 
							module.effect3 = module.effect3; 
				(settings.fx2pad3set == true) && slot1.value == module.effect1 ? knob1.value = settings.fx2pad3value/100 : module.effect1 = module.effect1 	
					(settings.fx2pad3set == true) && slot2.value == module.effect1 ? knob2.value = settings.fx2pad3value/100 : module.effect1 = module.effect1 	
						(settings.fx2pad3set == true) && slot3.value == module.effect1 ? knob3.value = settings.fx2pad3value/100 : module.effect1 = module.effect1 	
			}
			...
			(slot1.value == module.effect4) || (slot2.value == module.effect4) || (slot3.value == module.effect4) ? (slot1.value == module.effect4 ? slot1.value = 0 : slot2.value == module.effect4 ? slot2.value = 0 : slot3.value == module.effect4 ? slot3.value = 0 : module.effect4 = module.effect4) :	
				!module.button1val ? slot1.value = module.effect4 : 
					!module.button2val ? slot2.value = module.effect4 : 
						!module.button3val ? slot3.value = module.effect4 : 
							module.effect4 = module.effect4; 
				(settings.fx2pad4set == true) && slot1.value == module.effect1 ? knob1.value = settings.fx2pad4value/100 : module.effect1 = module.effect1 	
					(settings.fx2pad4set == true) && slot2.value == module.effect1 ? knob2.value = settings.fx2pad4value/100 : module.effect1 = module.effect1 	
						(settings.fx2pad4set == true) && slot3.value == module.effect1 ? knob3.value = settings.fx2pad4value/100 : module.effect1 = module.effect1 	
			}
			...
			(slot1.value == module.effect5) || (slot2.value == module.effect5) || (slot3.value == module.effect5) ? (slot1.value == module.effect5 ? slot1.value = 0 : slot2.value == module.effect5 ? slot2.value = 0 : slot3.value == module.effect5 ? slot3.value = 0 : module.effect5 = module.effect5) :	
				!module.button1val ? slot1.value = module.effect5 : 
					!module.button2val ? slot2.value = module.effect5 : 
						!module.button3val ? slot3.value = module.effect5 : 
							module.effect5 = module.effect5; 
				(settings.fx2pad5set == true) && slot1.value == module.effect1 ? knob1.value = settings.fx2pad5value/100 : module.effect1 = module.effect1 	
					(settings.fx2pad5set == true) && slot2.value == module.effect1 ? knob2.value = settings.fx2pad5value/100 : module.effect1 = module.effect1 	
						(settings.fx2pad5set == true) && slot3.value == module.effect1 ? knob3.value = settings.fx2pad5value/100 : module.effect1 = module.effect1 	
			}
			...
			(slot1.value == module.effect6) || (slot2.value == module.effect6) || (slot3.value == module.effect6) ? (slot1.value == module.effect6 ? slot1.value = 0 : slot2.value == module.effect6 ? slot2.value = 0 : slot3.value == module.effect6 ? slot3.value = 0 : module.effect6 = module.effect6) :	
				!module.button1val ? slot1.value = module.effect6 : 
					!module.button2val ? slot2.value = module.effect6 : 
						!module.button3val ? slot3.value = module.effect6 : 
							module.effect6 = module.effect6; 
				(settings.fx2pad6set == true) && slot1.value == module.effect1 ? knob1.value = settings.fx2pad6value/100 : module.effect1 = module.effect1 	
					(settings.fx2pad6set == true) && slot2.value == module.effect1 ? knob2.value = settings.fx2pad6value/100 : module.effect1 = module.effect1 	
						(settings.fx2pad6set == true) && slot3.value == module.effect1 ? knob3.value = settings.fx2pad6value/100 : module.effect1 = module.effect1 	
			}
			...
			(slot1.value == module.effect7) || (slot2.value == module.effect7) || (slot3.value == module.effect7) ? (slot1.value == module.effect7 ? slot1.value = 0 : slot2.value == module.effect7 ? slot2.value = 0 : slot3.value == module.effect7 ? slot3.value = 0 : module.effect7 = module.effect7) :	
				!module.button1val ? slot1.value = module.effect7 : 
					!module.button2val ? slot2.value = module.effect7 : 
						!module.button3val ? slot3.value = module.effect7 : 
							module.effect7 = module.effect7; 
				(settings.fx2pad7set == true) && slot1.value == module.effect1 ? knob1.value = settings.fx2pad7value/100 : module.effect1 = module.effect1 	
					(settings.fx2pad7set == true) && slot2.value == module.effect1 ? knob2.value = settings.fx2pad7value/100 : module.effect1 = module.effect1 	
						(settings.fx2pad7set == true) && slot3.value == module.effect1 ? knob3.value = settings.fx2pad7value/100 : module.effect1 = module.effect1 	
			}
			...
			(slot1.value == module.effect8) || (slot2.value == module.effect8) || (slot3.value == module.effect8) ? (slot1.value == module.effect8 ? slot1.value = 0 : slot2.value == module.effect8 ? slot2.value = 0 : slot3.value == module.effect8 ? slot3.value = 0 : module.effect8 = module.effect8) :	
				!module.button1val ? slot1.value = module.effect8 : 
					!module.button2val ? slot2.value = module.effect8 : 
						!module.button3val ? slot3.value = module.effect8 : 
							module.effect8 = module.effect8; 
				(settings.fx2pad8set == true) && slot1.value == module.effect1 ? knob1.value = settings.fx2pad8value/100 : module.effect1 = module.effect1 	
					(settings.fx2pad8set == true) && slot2.value == module.effect1 ? knob2.value = settings.fx2pad8value/100 : module.effect1 = module.effect1 	
						(settings.fx2pad8set == true) && slot3.value == module.effect1 ? knob3.value = settings.fx2pad8value/100 : module.effect1 = module.effect1 	
			}
