...
Traktor.Stripe {
  ...
  AppProperty { id: trackEndWarningVar;        path: "app.traktor.decks." + (deckId+1) + ".track.track_end_warning" }
  property bool          trackEndWarning: trackEndWarningVar.value
  readonly property var  waveformColors:   colors.getDefaultWaveformColors(deckId+1)
  ...
  Repeater {
    ...
    Hotcue
    {
      ...
      name:			   hotcuesModel.array[index].name
      smallHead:       false
    }
  }
