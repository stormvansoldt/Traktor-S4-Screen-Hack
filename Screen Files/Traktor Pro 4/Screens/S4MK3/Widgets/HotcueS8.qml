...
Item {
  ...
  AppProperty { id: cueNameProp;			path: "app.traktor.decks." + parent.deckId + ".track.cue.hotcues." + hotcue.hotcueId + ".name"; }
  ...
  property int cueNameCheck: cueNameProp.value == name1 ? 1 : cueNameProp.value == name2 ? 2 : cueNameProp.value == name3 ? 3 : cueNameProp.value == name4 ? 4 : cueNameProp.value == name5 ? 5 : cueNameProp.value == name6 ? 6 : cueNameProp.value == name7 ? 7 : cueNameProp.value == name8 ? 8 : 0
  
  property bool cueNameMatch: !settings.hotcueNameColours || cueNameCheck == 0 ? false : true
  
  function nameColour(inputName) {
  	switch(inputName) {
  		case 0: return 16;
  		case 1: return settings.hotcueName1Colour;
  		case 2: return settings.hotcueName2Colour;
  		case 3: return settings.hotcueName3Colour;
  		case 4: return settings.hotcueName4Colour;
  		case 5: return settings.hotcueName5Colour;
  		case 6: return settings.hotcueName6Colour;
  		case 7: return settings.hotcueName7Colour;
  		case 8: return settings.hotcueName8Colour;
  	}
  ...
  AppProperty { id: type;   path: "app.traktor.decks." + (parent.deckId) + ".track.cue.hotcues." + hotcue.hotcueId + ".type"   }
  AppProperty { id: active; path: "app.traktor.decks." + (parent.deckId) + ".track.cue.hotcues." + hotcue.hotcueId + ".active" }
  AppProperty { id: exists; path: "app.traktor.decks." + (parent.deckId) + ".track.cue.hotcues." + hotcue.hotcueId + ".exists" }
  ...
  Component {
    ...
    Traktor.Polygon {
      ...
      color:              cueNameMatch ? colors.cueColours[nameColour(cueNameCheck)] : colors.cueColours[settings.cueGridColour]
  ...
  Component {
    ...
    Traktor.Polygon {
      ...
      color:              cueNameMatch ? colors.cueColours[nameColour(cueNameCheck)] : colors.cueColours[settings.cueCueColour] 
      border.width:       borderWidth
      border.color:       colors.colorBlack50
      points: [ Qt.point(0 , 0)
              , Qt.point(12, 0)
  ...
  Component {
    ...
    Traktor.Polygon {
      ...
      color:               cueNameMatch ? colors.cueColours[nameColour(cueNameCheck)] : colors.cueColours[settings.cueFadeInColour]
      border.width:        borderWidth
      border.color:        colors.colorBlack50
  ...
  Component {
    ...
    Traktor.Polygon {
      ...
      color:              cueNameMatch ? colors.cueColours[nameColour(cueNameCheck)] : colors.cueColours[settings.cueFadeOutColour]
      border.width:       borderWidth
      border.color:       colors.colorBlack50
      points: [ Qt.point(0, 0)
              , Qt.point(12, 0)
  ...
  Component {
    ...
    Item {
      ...
      Rectangle {
        ...
        anchors.horizontalCenter:  parent.horizontalCenter
        anchors.topMargin:         -1
        color:                     cueNameMatch ? colors.cueColours[nameColour(cueNameCheck)] : colors.cueColours[settings.cueLoadColour]
        width:                     15 
        height:                    width
        radius:                    0.5*width
        border.width:              1
   ...
   Component {
    ...
    Item {
      ...
      Traktor.Polygon {
        ...
        antialiasing: true
        color:             cueNameMatch ? colors.cueColours[nameColour(cueNameCheck)] : colors.cueColours[settings.cueLoopColour]   
        border.width:       borderWidth
        border.color:       colors.colorBlack50
  ...
  states: [
    ...
    State {
      name: "grid";
      PropertyChanges { target: hotcue;      hotcueColor:     cueNameMatch ? colors.cueColours[nameColour(cueNameCheck)] : colors.cueColours[settings.cueGridColour]   }
    ...
    State {
      name: "hotcue";
      PropertyChanges { target: hotcue;      hotcueColor:     cueNameMatch ? colors.cueColours[nameColour(cueNameCheck)] : colors.cueColours[settings.cueCueColour] } 
      PropertyChanges { target: cueLoader;   sourceComponent: smallHead ? hotcueComponentSmall : hotcueComponentLarge  }
      PropertyChanges { target: hotcue;      visible:         true   }
    },
    State {
      name: "fadeIn";
      PropertyChanges { target: hotcue;      hotcueColor:     cueNameMatch ? colors.cueColours[nameColour(cueNameCheck)] : colors.cueColours[settings.cueFadeInColour] } 
      PropertyChanges { target: cueLoader;   sourceComponent: smallHead ? fadeInComponentSmall : fadeInComponentLarge }
      PropertyChanges { target: hotcue;      visible:         true   }
    },
    State {
      name: "fadeOut";
      PropertyChanges { target: hotcue;      hotcueColor:     cueNameMatch ? colors.cueColours[nameColour(cueNameCheck)] : colors.cueColours[settings.cueFadeOutColour] } 
      PropertyChanges { target: cueLoader;   sourceComponent: smallHead ? fadeOutComponentSmall  : fadeOutComponentLarge }
      PropertyChanges { target: hotcue;      visible:         true   }
    },
    State {
      name: "load";
      PropertyChanges { target: hotcue;      hotcueColor:     cueNameMatch ? colors.cueColours[nameColour(cueNameCheck)] : colors.cueColours[settings.cueLoadColour] } 
      PropertyChanges { target: cueLoader;   sourceComponent: smallHead ? loadComponentSmall : loadComponentLarge }
      PropertyChanges { target: hotcue;      visible:         true   }
    },
    State {
       name: "loop";
      PropertyChanges { target: hotcue;      hotcueColor:     cueNameMatch ? colors.cueColours[nameColour(cueNameCheck)] : colors.cueColours[settings.cueLoopColour] } 
