...
// Original Maschine 2 Display Colors
  ...
  property variant waveformColorsMapDim: [
    // RGB
	{ low1:  rgba (200,   0,   0, 20),  low2:  rgba (245, 120,  10, 20),
      mid1:  rgba (241, 230, 110, 20),  mid2:  rgba ( 20, 245, 170, 20),
      high1: rgba (170, 255, 255, 20),  high2: rgba (215, 240, 255, 20)},
    // Default
    { low1:  rgba (24,   48,  80, 20),  low2:  rgba (24,   56,  96, 20),
      mid1:  rgba (80,  160, 160, 20),  mid2:  rgba (48,  112, 112, 20),
      high1: rgba (184, 240, 232, 20),  high2: rgba (208, 255, 248, 20) },
    // Red - #c80000
    { low1:  rgba (200,   0,   0, 20),  low2:  rgba (200,  30,  30, 20),
      mid1:  rgba (180, 100, 100, 20),  mid2:  rgba (180, 110, 110, 20),
      high1: rgba (220, 180, 180, 20),  high2: rgba (220, 200, 200, 20) },
    // Dark Orange - #ff3200
    { low1:  rgba (255,  50,   0, 150),  low2:  rgba (255,  70,  20, 170),
      mid1:  rgba (180,  70,  50, 120),  mid2:  rgba (180,  90,  70, 140),
      high1: rgba (255, 200, 160, 140),  high2: rgba (255, 220, 180, 160) },
