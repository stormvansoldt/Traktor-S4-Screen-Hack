...
Item {
  ...
  property int cueNameCheck: name == name1 ? 1 : name == name2 ? 2 : name == name3 ? 3 : name == name4 ? 4 : name == name5 ? 5 : name == name6 ? 6 : name == name7 ? 7 : name == name8 ? 8 : 0
  
  property bool cueNameMatch: !settings.hotcueNameColours || hotcue.cueNameCheck == 0 ? false : true
